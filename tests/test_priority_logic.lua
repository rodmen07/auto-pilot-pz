...
-- (code-health split, 2026-08-07).  The helper kit above STAYS: the V5.8 block
-- and the un-versioned tail below still call it (resetRest, placeFurniture,
-- windedPlayer, noFurniture, drivenPlayer, repAt).
--
-- Hidden coupling made explicit by the move: the V5.2 auto-rotation cases
-- above leave the fitness pool XP-fatigued (_exFatiguedUntil, 3 game-hours,
-- EXERCISE_FATIGUE_RECOVERY_MS), and the moved block's ~9 game-hours of
-- resetRest clock advancement was what let that fatigue expire before
-- V5.8-3 trains again.  Advance the clock explicitly instead, so the V5.8
-- cases stay independent of the moved block's side effects.
MockTime.advance(AutoPilot_Constants.EXERCISE_FATIGUE_RECOVERY_MS + 60000)
