...
-- ── Where the rest / endurance / smoke-regression blocks went ────────────────
...
-- despite the XP fatigue the V5.2 auto-rotation block leaves on the fitness
-- pool; nothing below this point trains, so there is no fatigue left to wait
-- out.
